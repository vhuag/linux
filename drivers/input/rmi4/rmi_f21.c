...
static irqreturn_t rmi_f21_attention(int irq, void *ctx)
{
    ...
    if (drvdata->attn_data.data) {
        ...
        pressed = !!(f21->data_regs[RMI_F21_INPUT_REPORT_FORCE_CLICK_OFFSET] & RMI_f21_FORCE_CLICK);
    } else {
        ...
        pressed = !!(f21->data_regs[RMI_F21_TABLE_FORCE_CLICK_OFFSET] & RMI_f21_FORCE_CLICK);
    }
